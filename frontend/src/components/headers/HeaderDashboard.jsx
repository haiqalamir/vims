...
export default function HeaderDashboard() {
  ...
  // Handlers for search box focus/blur remain similar to previous header
  const handleFocus = () => {
  ...
  return (
    <header className="prima-header header-style-ten">
              ...
              <div className="btn-box">
                <div className="layout-search style1">
                  ...
                  <div className="box-content-search" id="box-content-search">
                    ...
                    <Link to={`/my-listings`} className="btn-view-search">
                      View More
                      <svg
                        width={14}
                        height={14}
