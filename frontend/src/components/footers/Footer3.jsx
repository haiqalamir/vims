...
export default function Footer3({ parenttClass = "prima-footer footer-style-five" }) {
  // Dynamic brands state – will hold up to 8 unique brand names.
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        // Extract unique brands and filter out any falsy values.
